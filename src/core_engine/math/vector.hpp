...
public:
    ...
    vec4(const vec<T, 4>& r) { (*this)[0] = r[0]; (*this)[1] = r[1]; (*this)[2] = r[2]; (*this)[3] = r[3]; }
    vec4(T x, T y, T z, T w) { (*this)[0] = x; (*this)[1] = y; (*this)[2] = z; (*this)[3] = w; }
...
{
public:
    vec3f(float x = 0.0f, float y = 0.0f, float z = 0.0f) { (*this)[0] = x; (*this)[1] = y; (*this)[2] = z; }
    vec3f(const vec2<float>& r, float z) { (*this)[0] = r[0]; (*this)[1] = r[1]; (*this)[2] = z; }
    vec3f(float x, const vec2<float>& r) { (*this)[0] = x; (*this)[1] = r[1]; (*this)[2] = r[2]; }
    vec3f(const vec3<float>& r) { (*this)[0] = r[0]; (*this)[1] = r[1]; (*this)[2] = r[2]; }
    ...
    {
        return vec3f(get_y() * v.get_z() - get_z() * v.get_y(),
    ...
    inline vec3f negate() { return vec3f(-get_x(), -get_y(), -get_z()); }
    ...
    {
        (*this)[0] += r.get_x(); (*this)[1] += r.get_y(); (*this)[2] += r.get_z();
        return *this;
    }
    ...
    inline vec2<float> xy() const { return vec2<float>((*this)[0], (*this)[1]); }
    inline vec2<float> xz() const { return vec2<float>((*this)[0], (*this)[2]); }
    inline vec2<float> yz() const { return vec2<float>((*this)[1], (*this)[2]); }
    ...
    inline void set(const vec2<float>& r, float z) { (*this)[0] = r[0]; (*this)[1] = r[1]; (*this)[2] = z; }
    inline void set(const vec3f &v) { set_x(v.get_x()); set_y(v.get_y()); set_z(v.get_z()); }
private:
    //float x,y,z;
};
