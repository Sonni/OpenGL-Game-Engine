#ifndef INC_3D_ENGINE_SKELETAL_ANIMATION_HPP
#define INC_3D_ENGINE_SKELETAL_ANIMATION_HPP

#include <map>
#include <vector>
#include "../../core_engine/math/quaternion.hpp"
...
#endif //INC_3D_ENGINE_SKELETAL_ANIMATION_HPP
